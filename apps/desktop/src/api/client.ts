...
// "Timed out connecting to Houdry backend" that hangs the UI (#48504).
//
...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Houdry gateway connection closed',
      connectErrorMessage: 'Could not connect to Houdry gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Houdry gateway is not connected',
