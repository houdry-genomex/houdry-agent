...
export interface OAuthProvider {
   ...
   *  embedded terminal. Null when Houdry doesn't know how to remove it. */
...
// non-desktop) Houdry simply carries none of it. See store/profile-share.ts.
...
export interface SkillInfo {
  ...
  usage?: number
  /** 'agent' = learned/local (editable), 'bundled' = ships with Houdry, 'hub' = installed. */
 ...
 *  not Houdry); elsewhere, driver health from `cua-driver doctor`. `null`
