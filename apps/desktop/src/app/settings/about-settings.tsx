...
const RELEASE_NOTES_URL = 'https://github.com/houdry-genomex/houdry-agent/releases'
const INSTALLER_URL = 'https://github.com/houdry-genomex/houdry-agent/releases'
