...
/**
 * Return the Python snippet used to verify Houdry can import far enough to
...
/**
 * Return true iff the Houdry runtime import probe exits 0.
 *
 ...
 * its immutable, matching Houdry package; it must never fall through to the
