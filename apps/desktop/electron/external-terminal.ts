// Launching the Houdry TUI in the user's OWN terminal emulator.
//
...
// to work anywhere:
//
//  1. WHAT to run. The desktop's Houdry runtime is often a venv Python invoked
 ...
 * headless child) is the wrong answer for an interactive terminal. The Houdry
