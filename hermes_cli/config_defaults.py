...
OPTIONAL_ENV_VARS = {
    ...
    "AZURE_FOUNDRY_API_KEY": {
        "description": "Azure Foundry / Azure OpenAI API key (alias: AZURE_OPENAI_API_KEY)",
    ...
    "AZURE_FOUNDRY_BASE_URL": {
        "description": "Azure Foundry base URL (alias: AZURE_OPENAI_ENDPOINT)",
    ...
    "AZURE_OPENAI_API_KEY": {
        "description": "Azure OpenAI API key (same as AZURE_FOUNDRY_API_KEY)",
    ...
    "AZURE_OPENAI_ENDPOINT": {
        "description": "Azure OpenAI resource endpoint (normalized to .../openai/v1)",
    ...
    "AZURE_OPENAI_DEPLOYMENT": {
        "description": "Azure OpenAI deployment name (e.g. gpt-5.6-luna) used as model id",
        "prompt": "Azure OpenAI Deployment",
        "url": None,
        "password": False,
        "category": "provider",
    },
    "AZURE_OPENAI_API_VERSION": {
        "description": "Azure OpenAI api_version for chat (portal default: 2024-12-01-preview)",
